---
name: minimal-reproduction-construction
description: "Shrinking a failure to its smallest reproducing case before proposing a cause"
owner: debugging-specialist
...
Shrinking a failure to its smallest reproducing case before proposing a cause.

## When this applies

Invoke this when the task in front of you is minimal reproduction construction — not by default, and not
...
It grants no capability. If applying it requires a tool `debugging-specialist` does not hold,
