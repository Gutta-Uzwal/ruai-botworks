...
description: "Pinning current behaviour in tests before changing any of it"
owner: legacy-modernizer
...
Pinning current behaviour in tests before changing any of it.

## When this applies

Invoke this when the task in front of you is characterisation testing — not by default, and not
...
It grants no capability. If applying it requires a tool `legacy-modernizer` does not hold,
