---
name: refactor-without-rewrite
description: "Behaviour-preserving moves, and recognising when duplication is cheaper than the wrong abstraction"
owner: code-refactoring-engineer
...
Behaviour-preserving moves, and recognising when duplication is cheaper than the wrong abstraction.

## When this applies

Invoke this when the task in front of you is refactor without rewrite — not by default, and not
...
It grants no capability. If applying it requires a tool `code-refactoring-engineer` does not hold,
