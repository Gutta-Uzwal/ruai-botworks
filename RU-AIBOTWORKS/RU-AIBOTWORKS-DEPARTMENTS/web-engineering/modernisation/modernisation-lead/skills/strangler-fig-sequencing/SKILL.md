---
name: strangler-fig-sequencing
description: "Incremental replacement where every step is shippable and reversible"
owner: modernisation-lead
...
Incremental replacement where every step is shippable and reversible.

## When this applies

Invoke this when the task in front of you is strangler fig sequencing — not by default, and not
...
It grants no capability. If applying it requires a tool `modernisation-lead` does not hold,
