---
name: debt-impact-scoring
description: "Scoring debt by change frequency times defect density, not by how ugly it looks"
owner: tech-debt-analyst
...
Scoring debt by change frequency times defect density, not by how ugly it looks.

## When this applies

Invoke this when the task in front of you is debt impact scoring — not by default, and not
...
It grants no capability. If applying it requires a tool `tech-debt-analyst` does not hold,
