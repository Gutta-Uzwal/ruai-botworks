...
description: "Nullability, pagination and dataloader batching that stops resolver fan-out"
owner: graphql-architect
...
Nullability, pagination and dataloader batching that stops resolver fan-out.

## When this applies

Invoke this when the task in front of you is graphql schema design — not by default, and not
...
It grants no capability. If applying it requires a tool `graphql-architect` does not hold,
