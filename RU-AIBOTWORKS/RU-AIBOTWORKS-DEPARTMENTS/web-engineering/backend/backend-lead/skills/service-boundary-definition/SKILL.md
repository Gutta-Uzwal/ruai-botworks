---
name: service-boundary-definition
description: "Where one service ends, what it owns, and what it must never read directly"
owner: backend-lead
...
Where one service ends, what it owns, and what it must never read directly.

## When this applies

Invoke this when the task in front of you is service boundary definition — not by default, and not
