---
name: token-lifecycle-design
description: "Short leases, rotation, and revocation that actually takes effect"
owner: auth-systems-engineer
...
Short leases, rotation, and revocation that actually takes effect.

## When this applies

Invoke this when the task in front of you is token lifecycle design — not by default, and not
...
It grants no capability. If applying it requires a tool `auth-systems-engineer` does not hold,
