---
name: realtime-connection-management
description: "Backpressure, reconnection and the fan-out ceiling you must declare up front"
...
Backpressure, reconnection and the fan-out ceiling you must declare up front.

## When this applies

Invoke this when the task in front of you is realtime connection management — not by default, and not
...
It grants no capability. If applying it requires a tool `realtime-engineer` does not hold,
