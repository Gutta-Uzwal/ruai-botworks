...
description: "Analysers, ranking and measuring relevance against a labelled set rather than by feel"
...
Analysers, ranking and measuring relevance against a labelled set rather than by feel.

## When this applies

Invoke this when the task in front of you is relevance tuning — not by default, and not
...
It grants no capability. If applying it requires a tool `search-engineer` does not hold,
