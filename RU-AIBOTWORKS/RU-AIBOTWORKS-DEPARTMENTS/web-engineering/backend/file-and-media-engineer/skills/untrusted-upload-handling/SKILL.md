---
name: untrusted-upload-handling
description: "Type sniffing, size caps and out-of-band processing for files you did not author"
owner: file-and-media-engineer
...
Type sniffing, size caps and out-of-band processing for files you did not author.

## When this applies

Invoke this when the task in front of you is untrusted upload handling — not by default, and not
...
It grants no capability. If applying it requires a tool `file-and-media-engineer` does not hold,
