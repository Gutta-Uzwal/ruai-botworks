---
name: authorization-on-resolved-entity
description: "Authorising the entity, not the endpoint — the difference OWASP ASI03 turns on"
...
# authorization on resolved entity

Authorising the entity, not the endpoint — the difference owasp asi03 turns on.

## When this applies

Invoke this when the task in front of you is authorization on resolved entity — not by default, and not
...
It grants no capability. If applying it requires a tool `api-security-engineer` does not hold,
