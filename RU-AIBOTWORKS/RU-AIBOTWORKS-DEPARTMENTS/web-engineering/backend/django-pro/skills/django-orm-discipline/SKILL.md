---
name: django-orm-discipline
description: "select_related, prefetch_related and finding the N+1 before it reaches load test"
owner: django-pro
...
# django orm discipline

Select_related, prefetch_related and finding the n+1 before it reaches load test.

## When this applies

Invoke this when the task in front of you is django orm discipline — not by default, and not
...
It grants no capability. If applying it requires a tool `django-pro` does not hold,
