---
name: drf-serializer-design
description: "Serializers that validate at the boundary instead of trusting the view"
owner: django-pro
...
# drf serializer design

Serializers that validate at the boundary instead of trusting the view.

## When this applies

Invoke this when the task in front of you is drf serializer design — not by default, and not
