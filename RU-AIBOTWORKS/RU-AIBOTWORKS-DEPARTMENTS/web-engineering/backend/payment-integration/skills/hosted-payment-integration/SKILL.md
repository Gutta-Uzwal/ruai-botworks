...
description: "Hosted fields and SAQ-A scope: keeping card data out of our systems entirely"
owner: payment-integration
...
Hosted fields and saq-a scope: keeping card data out of our systems entirely.

## When this applies

Invoke this when the task in front of you is hosted payment integration — not by default, and not
...
It grants no capability. If applying it requires a tool `payment-integration` does not hold,
