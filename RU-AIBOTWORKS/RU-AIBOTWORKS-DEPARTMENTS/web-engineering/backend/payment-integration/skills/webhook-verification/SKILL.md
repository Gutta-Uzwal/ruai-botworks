...
description: "Signature checks, replay windows and idempotent webhook handlers"
...
Signature checks, replay windows and idempotent webhook handlers.

## When this applies

Invoke this when the task in front of you is webhook verification — not by default, and not
