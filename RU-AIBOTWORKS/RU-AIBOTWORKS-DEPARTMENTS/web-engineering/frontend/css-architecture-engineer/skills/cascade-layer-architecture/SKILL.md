---
name: cascade-layer-architecture
description: "Layers, custom properties and specificity budgets that keep CSS predictable at scale"
owner: css-architecture-engineer
...
Layers, custom properties and specificity budgets that keep css predictable at scale.

## When this applies

Invoke this when the task in front of you is cascade layer architecture — not by default, and not
...
It grants no capability. If applying it requires a tool `css-architecture-engineer` does not hold,
