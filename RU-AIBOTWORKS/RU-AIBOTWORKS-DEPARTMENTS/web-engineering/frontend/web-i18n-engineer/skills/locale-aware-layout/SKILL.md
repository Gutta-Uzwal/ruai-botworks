---
name: locale-aware-layout
description: "RTL, pluralisation and date formatting designed in rather than retrofitted"
owner: web-i18n-engineer
...
Rtl, pluralisation and date formatting designed in rather than retrofitted.

## When this applies

Invoke this when the task in front of you is locale aware layout — not by default, and not
...
It grants no capability. If applying it requires a tool `web-i18n-engineer` does not hold,
