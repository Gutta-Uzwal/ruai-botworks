---
name: chart-encoding-selection
description: "Choosing the mark from the question, and a palette that survives dark mode and colour blindness"
owner: data-visualisation-engineer
...
# chart encoding selection

Choosing the mark from the question, and a palette that survives dark mode and colour blindness.

## When this applies

Invoke this when the task in front of you is chart encoding selection — not by default, and not
...
It grants no capability. If applying it requires a tool `data-visualisation-engineer` does not hold,
