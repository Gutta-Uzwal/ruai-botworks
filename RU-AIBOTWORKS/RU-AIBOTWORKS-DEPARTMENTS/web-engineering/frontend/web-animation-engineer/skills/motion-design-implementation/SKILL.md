---
name: motion-design-implementation
description: "Easing, duration and prefers-reduced-motion as a first-class branch, not an afterthought"
owner: web-animation-engineer
...
Easing, duration and prefers-reduced-motion as a first-class branch, not an afterthought.

## When this applies

Invoke this when the task in front of you is motion design implementation — not by default, and not
...
It grants no capability. If applying it requires a tool `web-animation-engineer` does not hold,
