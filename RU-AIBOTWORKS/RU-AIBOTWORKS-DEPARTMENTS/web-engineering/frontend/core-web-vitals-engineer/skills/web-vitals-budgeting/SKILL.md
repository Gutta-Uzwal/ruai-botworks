---
name: web-vitals-budgeting
description: "Setting a CWV budget before the hero image is chosen, and enforcing it in the gate"
owner: core-web-vitals-engineer
...
# web vitals budgeting

Setting a cwv budget before the hero image is chosen, and enforcing it in the gate.

## When this applies

Invoke this when the task in front of you is web vitals budgeting — not by default, and not
...
It grants no capability. If applying it requires a tool `core-web-vitals-engineer` does not hold,
