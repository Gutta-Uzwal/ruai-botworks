---
name: component-boundary-design
description: "Deciding where one component ends and the next begins, and why the wrong cut costs a rewrite"
owner: frontend-lead
...
Deciding where one component ends and the next begins, and why the wrong cut costs a rewrite.

## When this applies

Invoke this when the task in front of you is component boundary design — not by default, and not
...
It grants no capability. If applying it requires a tool `frontend-lead` does not hold,
