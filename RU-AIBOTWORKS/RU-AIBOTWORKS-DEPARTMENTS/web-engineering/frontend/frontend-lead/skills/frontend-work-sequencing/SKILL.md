---
name: frontend-work-sequencing
description: "Ordering frontend tasks so shared primitives land before the screens that need them"
owner: frontend-lead
...
Ordering frontend tasks so shared primitives land before the screens that need them.

## When this applies

Invoke this when the task in front of you is frontend work sequencing — not by default, and not
