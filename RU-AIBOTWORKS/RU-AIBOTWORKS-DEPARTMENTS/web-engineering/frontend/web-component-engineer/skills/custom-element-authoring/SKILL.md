---
name: custom-element-authoring
description: "Shadow DOM, slots and the styling boundary that makes reuse actually work"
owner: web-component-engineer
...
Shadow dom, slots and the styling boundary that makes reuse actually work.

## When this applies

Invoke this when the task in front of you is custom element authoring — not by default, and not
...
It grants no capability. If applying it requires a tool `web-component-engineer` does not hold,
