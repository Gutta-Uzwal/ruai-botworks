---
name: keyboard-and-focus-management
description: "Focus order, traps, and skip links — the half of WCAG that automated scans miss"
owner: web-accessibility-engineer
...
Focus order, traps, and skip links — the half of wcag that automated scans miss.

## When this applies

Invoke this when the task in front of you is keyboard and focus management — not by default, and not
...
It grants no capability. If applying it requires a tool `web-accessibility-engineer` does not hold,
