---
name: bundle-budget-enforcement
description: "Splitting on measured route cost rather than on intuition about what is big"
...
Splitting on measured route cost rather than on intuition about what is big.

## When this applies

Invoke this when the task in front of you is bundle budget enforcement — not by default, and not
...
It grants no capability. If applying it requires a tool `frontend-build-engineer` does not hold,
