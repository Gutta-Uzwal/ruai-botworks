...
description: "Composition, controlled state, and the hook rules that stop re-render storms"
...
Composition, controlled state, and the hook rules that stop re-render storms.

## When this applies

Invoke this when the task in front of you is react component patterns — not by default, and not
