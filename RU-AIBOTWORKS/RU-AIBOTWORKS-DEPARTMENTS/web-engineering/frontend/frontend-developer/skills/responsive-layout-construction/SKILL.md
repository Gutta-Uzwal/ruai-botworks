---
name: responsive-layout-construction
description: "Container queries, fluid type and grid that survives 400px without a horizontal scrollbar"
...
Container queries, fluid type and grid that survives 400px without a horizontal scrollbar.

## When this applies

Invoke this when the task in front of you is responsive layout construction — not by default, and not
...
It grants no capability. If applying it requires a tool `frontend-developer` does not hold,
