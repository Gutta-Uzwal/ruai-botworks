---
name: no-js-baseline-construction
description: "Server-rendered baseline first, enhancement second — the Lane B discipline"
owner: progressive-enhancement-engineer
...
# no js baseline construction

Server-rendered baseline first, enhancement second — the lane b discipline.

## When this applies

Invoke this when the task in front of you is no js baseline construction — not by default, and not
...
It grants no capability. If applying it requires a tool `progressive-enhancement-engineer` does not hold,
