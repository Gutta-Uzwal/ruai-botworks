---
name: type-level-api-design
description: "Types that make the wrong call unrepresentable rather than merely flagged"
...
Types that make the wrong call unrepresentable rather than merely flagged.

## When this applies

Invoke this when the task in front of you is type level api design — not by default, and not
...
It grants no capability. If applying it requires a tool `typescript-pro` does not hold,
