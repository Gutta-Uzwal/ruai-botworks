...
description: "Borrow-checker shapes that avoid fighting it, and when Arc is the honest answer"
owner: rust-pro
...
Borrow-checker shapes that avoid fighting it, and when arc is the honest answer.

## When this applies

Invoke this when the task in front of you is ownership and lifetimes — not by default, and not
...
It grants no capability. If applying it requires a tool `rust-pro` does not hold,
