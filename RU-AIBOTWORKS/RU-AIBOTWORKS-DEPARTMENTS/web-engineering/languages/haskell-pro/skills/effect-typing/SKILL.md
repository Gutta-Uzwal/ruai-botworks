---
name: effect-typing
description: "Pushing effects to the edges so the core stays total and testable"
owner: haskell-pro
...
Pushing effects to the edges so the core stays total and testable.

## When this applies

Invoke this when the task in front of you is effect typing — not by default, and not
...
It grants no capability. If applying it requires a tool `haskell-pro` does not hold,
