...
description: "asyncio structure, cancellation and the sync-in-async trap"
owner: python-pro
...
Asyncio structure, cancellation and the sync-in-async trap.

## When this applies

Invoke this when the task in front of you is python async patterns — not by default, and not
