...
description: "Protocols, generics and strict mypy settings that catch defects at edit time"
owner: python-pro
...
Protocols, generics and strict mypy settings that catch defects at edit time.

## When this applies

Invoke this when the task in front of you is python type discipline — not by default, and not
...
It grants no capability. If applying it requires a tool `python-pro` does not hold,
