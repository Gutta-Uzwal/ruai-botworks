---
name: bounds-and-lifetime-auditing
description: "Every allocation paired, every buffer bounded, every free once"
owner: c-pro
...
# bounds and lifetime auditing

Every allocation paired, every buffer bounded, every free once.

## When this applies

Invoke this when the task in front of you is bounds and lifetime auditing — not by default, and not
...
It grants no capability. If applying it requires a tool `c-pro` does not hold,
