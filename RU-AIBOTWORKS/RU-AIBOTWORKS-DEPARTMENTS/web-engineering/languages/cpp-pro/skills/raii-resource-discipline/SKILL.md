---
name: raii-resource-discipline
description: "Ownership types and why a raw owning pointer is a review finding"
owner: cpp-pro
...
# raii resource discipline

Ownership types and why a raw owning pointer is a review finding.

## When this applies

Invoke this when the task in front of you is raii resource discipline — not by default, and not
...
It grants no capability. If applying it requires a tool `cpp-pro` does not hold,
