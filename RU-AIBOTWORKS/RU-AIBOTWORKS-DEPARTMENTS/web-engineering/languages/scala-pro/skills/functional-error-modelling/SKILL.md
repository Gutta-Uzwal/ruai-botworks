---
name: functional-error-modelling
description: "Either, Validated and making failure a value rather than an exception"
owner: scala-pro
...
# functional error modelling

Either, validated and making failure a value rather than an exception.

## When this applies

Invoke this when the task in front of you is functional error modelling — not by default, and not
...
It grants no capability. If applying it requires a tool `scala-pro` does not hold,
