---
name: coroutine-scope-discipline
description: "Structured concurrency, scope ownership and cancellation that propagates"
owner: kotlin-pro
...
Structured concurrency, scope ownership and cancellation that propagates.

## When this applies

Invoke this when the task in front of you is coroutine scope discipline — not by default, and not
...
It grants no capability. If applying it requires a tool `kotlin-pro` does not hold,
