...
description: "ConfigureAwait, cancellation tokens and avoiding sync-over-async deadlocks"
owner: csharp-pro
...
Configureawait, cancellation tokens and avoiding sync-over-async deadlocks.

## When this applies

Invoke this when the task in front of you is dotnet async patterns — not by default, and not
...
It grants no capability. If applying it requires a tool `csharp-pro` does not hold,
