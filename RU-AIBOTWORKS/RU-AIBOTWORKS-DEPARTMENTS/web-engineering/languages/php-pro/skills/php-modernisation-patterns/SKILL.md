---
name: php-modernisation-patterns
description: "Strict types, DI containers and leaving the superglobal era behind"
owner: php-pro
...
# php modernisation patterns

Strict types, di containers and leaving the superglobal era behind.

## When this applies

Invoke this when the task in front of you is php modernisation patterns — not by default, and not
...
It grants no capability. If applying it requires a tool `php-pro` does not hold,
