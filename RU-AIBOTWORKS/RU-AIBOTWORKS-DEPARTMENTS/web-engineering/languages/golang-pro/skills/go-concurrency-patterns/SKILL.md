...
description: "Context propagation, cancellation and closing channels exactly once"
owner: golang-pro
...
Context propagation, cancellation and closing channels exactly once.

## When this applies

Invoke this when the task in front of you is go concurrency patterns — not by default, and not
...
It grants no capability. If applying it requires a tool `golang-pro` does not hold,
