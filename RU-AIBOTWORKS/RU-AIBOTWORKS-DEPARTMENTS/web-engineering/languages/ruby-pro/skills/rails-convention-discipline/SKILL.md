---
name: rails-convention-discipline
description: "Fat model, thin controller — and where that advice stops being true"
owner: ruby-pro
...
# rails convention discipline

Fat model, thin controller — and where that advice stops being true.

## When this applies

Invoke this when the task in front of you is rails convention discipline — not by default, and not
...
It grants no capability. If applying it requires a tool `ruby-pro` does not hold,
