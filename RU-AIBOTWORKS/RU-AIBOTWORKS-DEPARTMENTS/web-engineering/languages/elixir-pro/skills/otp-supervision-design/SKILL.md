---
name: otp-supervision-design
description: "Let-it-crash with supervision trees that restart into a known-good state"
owner: elixir-pro
...
Let-it-crash with supervision trees that restart into a known-good state.

## When this applies

Invoke this when the task in front of you is otp supervision design — not by default, and not
...
It grants no capability. If applying it requires a tool `elixir-pro` does not hold,
