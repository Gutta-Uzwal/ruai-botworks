---
name: language-selection-advice
description: "When a second language earns its maintenance cost, and when it does not"
owner: languages-lead
...
When a second language earns its maintenance cost, and when it does not.

## When this applies

Invoke this when the task in front of you is language selection advice — not by default, and not
...
It grants no capability. If applying it requires a tool `languages-lead` does not hold,
