...
description: "Job success rather than pass percentage, and a cancelled job counted as a failure"
owner: cicd-lead
...
Job success rather than pass percentage, and a cancelled job counted as a failure.

## When this applies

Invoke this when the task in front of you is gate composition — not by default, and not
...
It grants no capability. If applying it requires a tool `cicd-lead` does not hold,
