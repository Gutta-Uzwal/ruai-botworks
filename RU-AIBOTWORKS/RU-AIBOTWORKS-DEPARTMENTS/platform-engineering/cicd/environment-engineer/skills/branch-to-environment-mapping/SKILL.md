---
name: branch-to-environment-mapping
description: "Nothing reaches production by hand — protection rules that make it structurally impossible"
...
Nothing reaches production by hand — protection rules that make it structurally impossible.

## When this applies

Invoke this when the task in front of you is branch to environment mapping — not by default, and not
...
It grants no capability. If applying it requires a tool `environment-engineer` does not hold,
