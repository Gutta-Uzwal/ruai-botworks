---
name: credential-lease-design
description: "Credentials as leases with a TTL, never as secrets that outlive a task"
...
# credential lease design

Credentials as leases with a ttl, never as secrets that outlive a task.

## When this applies

Invoke this when the task in front of you is credential lease design — not by default, and not
