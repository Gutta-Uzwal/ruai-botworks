---
name: transitive-closure-auditing
description: "Proving no agent identity can reach the backups, directly or by assuming a role"
owner: identity-and-access-engineer
...
# transitive closure auditing

Proving no agent identity can reach the backups, directly or by assuming a role.

## When this applies

Invoke this when the task in front of you is transitive closure auditing — not by default, and not
...
It grants no capability. If applying it requires a tool `identity-and-access-engineer` does not hold,
