---
name: environment-separation-enforcement
description: "Environment resolved by infrastructure, never by a string an agent can read or edit"
owner: cloud-lead
...
Environment resolved by infrastructure, never by a string an agent can read or edit.

## When this applies

Invoke this when the task in front of you is environment separation enforcement — not by default, and not
...
It grants no capability. If applying it requires a tool `cloud-lead` does not hold,
