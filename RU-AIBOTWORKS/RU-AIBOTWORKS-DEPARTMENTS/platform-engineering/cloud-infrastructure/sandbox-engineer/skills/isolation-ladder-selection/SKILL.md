---
name: isolation-ladder-selection
description: "Why a shared-kernel container is a management boundary and not a security boundary"
owner: sandbox-engineer
...
# isolation ladder selection

Why a shared-kernel container is a management boundary and not a security boundary.

## When this applies

Invoke this when the task in front of you is isolation ladder selection — not by default, and not
...
It grants no capability. If applying it requires a tool `sandbox-engineer` does not hold,
