---
name: infrastructure-as-code-discipline
description: "Plan-apply separation, drift detection, and no console changes that outlive the incident"
...
Plan-apply separation, drift detection, and no console changes that outlive the incident.

## When this applies

Invoke this when the task in front of you is infrastructure as code discipline — not by default, and not
...
It grants no capability. If applying it requires a tool `cloud-architect` does not hold,
