---
name: tool-contract-authoring
description: "Complete contracts before invocation, and a null rollback on Tier 2+ raised as a finding"
...
Complete contracts before invocation, and a null rollback on tier 2+ raised as a finding.

## When this applies

Invoke this when the task in front of you is tool contract authoring — not by default, and not
