---
name: offline-chain-verification
description: "A chain that verifies without the system that produced it, or it proves nothing"
owner: receipt-chain-engineer
...
A chain that verifies without the system that produced it, or it proves nothing.

## When this applies

Invoke this when the task in front of you is offline chain verification — not by default, and not
...
It grants no capability. If applying it requires a tool `receipt-chain-engineer` does not hold,
