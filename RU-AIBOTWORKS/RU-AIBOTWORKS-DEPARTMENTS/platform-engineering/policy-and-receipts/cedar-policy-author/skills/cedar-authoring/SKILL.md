...
description: "Principal, action, resource and context — and a deny that names why it denied"
owner: cedar-policy-author
...
Principal, action, resource and context — and a deny that names why it denied.

## When this applies

Invoke this when the task in front of you is cedar authoring — not by default, and not
...
It grants no capability. If applying it requires a tool `cedar-policy-author` does not hold,
