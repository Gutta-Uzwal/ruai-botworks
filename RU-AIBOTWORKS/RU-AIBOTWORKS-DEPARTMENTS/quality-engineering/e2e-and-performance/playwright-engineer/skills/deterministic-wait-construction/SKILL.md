---
name: deterministic-wait-construction
description: "Waiting on state rather than time — the single cause of most flaky suites"
owner: playwright-engineer
...
# deterministic wait construction

Waiting on state rather than time — the single cause of most flaky suites.

## When this applies

Invoke this when the task in front of you is deterministic wait construction — not by default, and not
...
It grants no capability. If applying it requires a tool `playwright-engineer` does not hold,
