---
name: visual-diff-thresholding
description: "Thresholds that catch layout breaks without failing on font rendering"
owner: visual-regression-engineer
...
# visual diff thresholding

Thresholds that catch layout breaks without failing on font rendering.

## When this applies

Invoke this when the task in front of you is visual diff thresholding — not by default, and not
...
It grants no capability. If applying it requires a tool `visual-regression-engineer` does not hold,
