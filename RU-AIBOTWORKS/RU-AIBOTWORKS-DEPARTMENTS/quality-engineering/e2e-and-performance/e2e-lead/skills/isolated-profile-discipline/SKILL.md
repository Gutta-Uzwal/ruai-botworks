---
name: isolated-profile-discipline
description: "A fresh browser profile every run, because a test that passes on leftover state proves nothing"
owner: e2e-lead
...
# isolated profile discipline

A fresh browser profile every run, because a test that passes on leftover state proves nothing.

## When this applies

Invoke this when the task in front of you is isolated profile discipline — not by default, and not
...
It grants no capability. If applying it requires a tool `e2e-lead` does not hold,
