...
description: "Realistic shapes with no real people in them — the rule that makes HIPAA projects buildable"
owner: test-data-engineer
...
Realistic shapes with no real people in them — the rule that makes hipaa projects buildable.

## When this applies

Invoke this when the task in front of you is synthetic fixture generation — not by default, and not
...
It grants no capability. If applying it requires a tool `test-data-engineer` does not hold,
