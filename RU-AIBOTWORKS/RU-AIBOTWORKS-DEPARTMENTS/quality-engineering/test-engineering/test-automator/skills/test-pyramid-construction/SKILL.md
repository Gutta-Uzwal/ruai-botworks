---
name: test-pyramid-construction
description: "Fast tests carrying the coverage and slow tests carrying the confidence"
...
Fast tests carrying the coverage and slow tests carrying the confidence.

## When this applies

Invoke this when the task in front of you is test pyramid construction — not by default, and not
...
It grants no capability. If applying it requires a tool `test-automator` does not hold,
