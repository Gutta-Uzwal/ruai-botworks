---
name: red-green-refactor-enforcement
description: "A failing test first, always — and why a test written after the code proves less"
owner: tdd-practice-engineer
...
A failing test first, always — and why a test written after the code proves less.

## When this applies

Invoke this when the task in front of you is red green refactor enforcement — not by default, and not
...
It grants no capability. If applying it requires a tool `tdd-practice-engineer` does not hold,
