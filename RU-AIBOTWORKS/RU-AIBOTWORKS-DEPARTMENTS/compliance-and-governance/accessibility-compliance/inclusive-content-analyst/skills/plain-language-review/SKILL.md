...
description: "Reading level, sentence length and instructions a stressed user can follow"
owner: inclusive-content-analyst
...
Reading level, sentence length and instructions a stressed user can follow.

## When this applies

Invoke this when the task in front of you is plain language review — not by default, and not
...
It grants no capability. If applying it requires a tool `inclusive-content-analyst` does not hold,
