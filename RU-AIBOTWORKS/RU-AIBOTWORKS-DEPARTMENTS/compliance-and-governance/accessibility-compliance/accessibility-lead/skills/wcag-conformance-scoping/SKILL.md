---
name: wcag-conformance-scoping
description: "Which success criteria apply to this interface, and the evidence each one needs"
...
# wcag conformance scoping

Which success criteria apply to this interface, and the evidence each one needs.

## When this applies

Invoke this when the task in front of you is wcag conformance scoping — not by default, and not
...
It grants no capability. If applying it requires a tool `accessibility-lead` does not hold,
