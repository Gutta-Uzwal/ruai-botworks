---
name: assistive-technology-audit
description: "Auditing with a screen reader running, because the accessibility tree on paper is not the experience"
...
Auditing with a screen reader running, because the accessibility tree on paper is not the experience.

## When this applies

Invoke this when the task in front of you is assistive technology audit — not by default, and not
...
It grants no capability. If applying it requires a tool `accessibility-expert` does not hold,
