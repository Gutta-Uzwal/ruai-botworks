---
name: framework-currency-review
description: "Re-verifying framework versions and regulatory deadlines every six months, because they move"
owner: regulatory-mapping-analyst
...
# framework currency review

Re-verifying framework versions and regulatory deadlines every six months, because they move.

## When this applies

Invoke this when the task in front of you is framework currency review — not by default, and not
...
It grants no capability. If applying it requires a tool `regulatory-mapping-analyst` does not hold,
