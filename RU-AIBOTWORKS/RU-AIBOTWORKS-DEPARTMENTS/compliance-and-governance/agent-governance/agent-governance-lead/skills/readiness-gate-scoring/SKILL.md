---
name: readiness-gate-scoring
description: "Scoring Appendix B from evidence rather than intent — a kill switch never pulled is a no"
owner: agent-governance-lead
...
# readiness gate scoring

Scoring appendix b from evidence rather than intent — a kill switch never pulled is a no.

## When this applies

Invoke this when the task in front of you is readiness gate scoring — not by default, and not
...
It grants no capability. If applying it requires a tool `agent-governance-lead` does not hold,
