---
name: engagement-billing-composition
description: "Billing from the metered ledger and the contract, never from an estimate"
owner: billing-lead
department: finance
...
# engagement billing composition

Billing from the metered ledger and the contract, never from an estimate.

## When this applies

Invoke this when the task in front of you is engagement billing composition — not by default, and not
...
It grants no capability. If applying it requires a tool `billing-lead` does not hold,
