---
name: engagement-margin-analysis
description: "Finding the engagement that looks profitable until rework and support are counted"
owner: margin-analyst
department: finance
...
# engagement margin analysis

Finding the engagement that looks profitable until rework and support are counted.

## When this applies

Invoke this when the task in front of you is engagement margin analysis — not by default, and not
...
It grants no capability. If applying it requires a tool `margin-analyst` does not hold,
