---
name: licence-spend-tracking
description: "Knowing what each dependency costs annually, including the ones nobody remembers renewing"
...
# licence spend tracking

Knowing what each dependency costs annually, including the ones nobody remembers renewing.

## When this applies

Invoke this when the task in front of you is licence spend tracking — not by default, and not
...
It grants no capability. If applying it requires a tool `procurement-analyst` does not hold,
