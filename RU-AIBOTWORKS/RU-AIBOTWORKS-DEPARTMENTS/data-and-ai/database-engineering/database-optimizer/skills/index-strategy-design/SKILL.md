...
description: "Covering indexes, selectivity and the write cost every index quietly adds"
...
Covering indexes, selectivity and the write cost every index quietly adds.

## When this applies

Invoke this when the task in front of you is index strategy design — not by default, and not
...
It grants no capability. If applying it requires a tool `database-optimizer` does not hold,
