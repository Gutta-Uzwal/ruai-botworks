---
name: set-based-query-construction
description: "Replacing procedural loops with set operations, and reading a query plan before optimising"
owner: sql-pro
...
# set based query construction

Replacing procedural loops with set operations, and reading a query plan before optimising.

## When this applies

Invoke this when the task in front of you is set based query construction — not by default, and not
...
It grants no capability. If applying it requires a tool `sql-pro` does not hold,
