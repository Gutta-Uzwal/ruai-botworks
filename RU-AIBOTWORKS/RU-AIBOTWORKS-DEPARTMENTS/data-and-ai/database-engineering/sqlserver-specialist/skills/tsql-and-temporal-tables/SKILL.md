---
name: tsql-and-temporal-tables
description: "System-versioned temporal tables for audit history the application cannot rewrite"
owner: sqlserver-specialist
...
# tsql and temporal tables

System-versioned temporal tables for audit history the application cannot rewrite.

## When this applies

Invoke this when the task in front of you is tsql and temporal tables — not by default, and not
...
It grants no capability. If applying it requires a tool `sqlserver-specialist` does not hold,
