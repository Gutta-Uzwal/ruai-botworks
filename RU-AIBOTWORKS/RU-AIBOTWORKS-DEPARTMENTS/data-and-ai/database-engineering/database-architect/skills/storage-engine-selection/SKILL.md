...
description: "Relational, document, time-series or vector chosen from access pattern rather than familiarity"
...
Relational, document, time-series or vector chosen from access pattern rather than familiarity.

## When this applies

Invoke this when the task in front of you is storage engine selection — not by default, and not
...
It grants no capability. If applying it requires a tool `database-architect` does not hold,
