---
name: embedding-index-design
description: "Chunking, dimensionality and recall measured against a labelled set"
owner: vector-database-engineer
...
Chunking, dimensionality and recall measured against a labelled set.

## When this applies

Invoke this when the task in front of you is embedding index design — not by default, and not
...
It grants no capability. If applying it requires a tool `vector-database-engineer` does not hold,
