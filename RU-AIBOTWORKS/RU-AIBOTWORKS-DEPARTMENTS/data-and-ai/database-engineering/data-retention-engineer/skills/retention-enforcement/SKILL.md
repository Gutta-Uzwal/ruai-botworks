...
description: "Soft-delete, tombstone and a reaper identity the agents cannot assume"
owner: data-retention-engineer
...
Soft-delete, tombstone and a reaper identity the agents cannot assume.

## When this applies

Invoke this when the task in front of you is retention enforcement — not by default, and not
...
It grants no capability. If applying it requires a tool `data-retention-engineer` does not hold,
