---
name: rag-grounding-design
description: "Retrieval that supports the claim, and citations checked rather than generated"
owner: ai-engineer
...
Retrieval that supports the claim, and citations checked rather than generated.

## When this applies

Invoke this when the task in front of you is rag grounding design — not by default, and not
...
It grants no capability. If applying it requires a tool `ai-engineer` does not hold,
