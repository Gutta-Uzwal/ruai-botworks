---
name: model-registry-discipline
description: "Pinned versions, lineage and rollback to a previous model as a first-class operation"
...
Pinned versions, lineage and rollback to a previous model as a first-class operation.

## When this applies

Invoke this when the task in front of you is model registry discipline — not by default, and not
...
It grants no capability. If applying it requires a tool `mlops-engineer` does not hold,
