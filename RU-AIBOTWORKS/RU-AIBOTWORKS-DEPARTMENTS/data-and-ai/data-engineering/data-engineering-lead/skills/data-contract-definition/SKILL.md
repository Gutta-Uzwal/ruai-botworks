---
name: data-contract-definition
description: "Schema, freshness and completeness promised to consumers — and alerted on when broken"
...
Schema, freshness and completeness promised to consumers — and alerted on when broken.

## When this applies

Invoke this when the task in front of you is data contract definition — not by default, and not
...
It grants no capability. If applying it requires a tool `data-engineering-lead` does not hold,
