---
name: expectation-suite-design
description: "Failing the batch loudly rather than letting bad rows reach a dashboard"
...
Failing the batch loudly rather than letting bad rows reach a dashboard.

## When this applies

Invoke this when the task in front of you is expectation suite design — not by default, and not
...
It grants no capability. If applying it requires a tool `data-quality-engineer` does not hold,
