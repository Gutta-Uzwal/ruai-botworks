---
name: analysis-honesty
description: "Stating uncertainty, sample size and what the data cannot answer"
...
Stating uncertainty, sample size and what the data cannot answer.

## When this applies

Invoke this when the task in front of you is analysis honesty — not by default, and not
...
It grants no capability. If applying it requires a tool `data-scientist` does not hold,
