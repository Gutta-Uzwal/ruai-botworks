---
name: cdc-ordering-guarantees
description: "Ordering, late arrivals and exactly-once semantics that are really effectively-once"
owner: cdc-engineer
...
Ordering, late arrivals and exactly-once semantics that are really effectively-once.

## When this applies

Invoke this when the task in front of you is cdc ordering guarantees — not by default, and not
...
It grants no capability. If applying it requires a tool `cdc-engineer` does not hold,
