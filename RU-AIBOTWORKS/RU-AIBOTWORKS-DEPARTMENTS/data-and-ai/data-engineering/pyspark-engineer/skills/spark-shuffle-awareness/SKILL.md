---
name: spark-shuffle-awareness
description: "Partitioning and broadcast joins, and spotting the shuffle that dominates the job"
owner: pyspark-engineer
...
# spark shuffle awareness

Partitioning and broadcast joins, and spotting the shuffle that dominates the job.

## When this applies

Invoke this when the task in front of you is spark shuffle awareness — not by default, and not
...
It grants no capability. If applying it requires a tool `pyspark-engineer` does not hold,
