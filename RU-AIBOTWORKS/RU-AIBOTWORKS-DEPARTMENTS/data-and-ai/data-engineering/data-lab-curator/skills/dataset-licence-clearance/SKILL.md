---
name: dataset-licence-clearance
description: "Clearing commercial use before a dataset influences anything that ships"
owner: data-lab-curator
...
# dataset licence clearance

Clearing commercial use before a dataset influences anything that ships.

## When this applies

Invoke this when the task in front of you is dataset licence clearance — not by default, and not
...
It grants no capability. If applying it requires a tool `data-lab-curator` does not hold,
