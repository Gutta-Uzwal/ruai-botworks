---
name: incident-roles-and-handoff
description: "Named roles, a single commander, and handoffs that transfer context rather than just the pager"
...
# incident roles and handoff

Named roles, a single commander, and handoffs that transfer context rather than just the pager.

## When this applies

Invoke this when the task in front of you is incident roles and handoff — not by default, and not
...
It grants no capability. If applying it requires a tool `incident-coordinator` does not hold,
