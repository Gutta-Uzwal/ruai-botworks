---
name: known-error-curation
description: "Recording the workaround and the permanent fix separately, and tracking the second to closure"
owner: problem-lead
...
# known error curation

Recording the workaround and the permanent fix separately, and tracking the second to closure.

## When this applies

Invoke this when the task in front of you is known error curation — not by default, and not
...
It grants no capability. If applying it requires a tool `problem-lead` does not hold,
