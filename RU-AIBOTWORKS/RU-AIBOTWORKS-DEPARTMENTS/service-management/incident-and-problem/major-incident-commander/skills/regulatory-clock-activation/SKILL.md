---
name: regulatory-clock-activation
description: "Starting the GDPR Art. 33 72-hour clock at awareness, and telling the DPO in the same minute"
owner: major-incident-commander
...
# regulatory clock activation

Starting the gdpr art. 33 72-hour clock at awareness, and telling the dpo in the same minute.

## When this applies

Invoke this when the task in front of you is regulatory clock activation — not by default, and not
...
It grants no capability. If applying it requires a tool `major-incident-commander` does not hold,
