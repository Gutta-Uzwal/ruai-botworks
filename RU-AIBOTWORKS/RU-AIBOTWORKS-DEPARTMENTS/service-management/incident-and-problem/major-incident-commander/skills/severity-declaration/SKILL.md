...
description: "Declaring early and downgrading later, because the cost of a late declaration is always higher"
...
Declaring early and downgrading later, because the cost of a late declaration is always higher.

## When this applies

Invoke this when the task in front of you is severity declaration — not by default, and not
