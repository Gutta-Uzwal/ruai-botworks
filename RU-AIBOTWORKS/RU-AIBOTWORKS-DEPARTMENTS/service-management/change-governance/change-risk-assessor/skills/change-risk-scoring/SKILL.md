...
description: "Blast radius, reversibility and time-to-detect — scored before approval, not after the incident"
owner: change-risk-assessor
...
Blast radius, reversibility and time-to-detect — scored before approval, not after the incident.

## When this applies

Invoke this when the task in front of you is change risk scoring — not by default, and not
...
It grants no capability. If applying it requires a tool `change-risk-assessor` does not hold,
