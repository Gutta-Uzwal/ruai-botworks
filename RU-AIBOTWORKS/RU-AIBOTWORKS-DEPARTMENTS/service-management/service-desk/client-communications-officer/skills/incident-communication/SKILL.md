...
description: "Saying what is known, what is not, and when the next update comes — and then sending it"
owner: client-communications-officer
...
Saying what is known, what is not, and when the next update comes — and then sending it.

## When this applies

Invoke this when the task in front of you is incident communication — not by default, and not
...
It grants no capability. If applying it requires a tool `client-communications-officer` does not hold,
