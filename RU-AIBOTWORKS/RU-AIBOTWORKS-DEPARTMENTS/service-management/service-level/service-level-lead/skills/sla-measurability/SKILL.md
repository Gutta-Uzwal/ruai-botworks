---
name: sla-measurability
description: "Only committing to what is measured today — an unmeasured SLA is a promise nobody can keep or disprove"
owner: service-level-lead
...
Only committing to what is measured today — an unmeasured sla is a promise nobody can keep or disprove.

## When this applies

Invoke this when the task in front of you is sla measurability — not by default, and not
...
It grants no capability. If applying it requires a tool `service-level-lead` does not hold,
