---
name: team-composition-from-triage
description: "Reading size and lane to pick the smallest team that can finish it"
owner: team-formation-analyst
...
# team composition from triage

Reading size and lane to pick the smallest team that can finish it.

## When this applies

Invoke this when the task in front of you is team composition from triage — not by default, and not
...
It grants no capability. If applying it requires a tool `team-formation-analyst` does not hold,
