---
name: phase-scoped-orchestration
description: "Running only inside a phase an officer opened — capability does not confer authority"
...
# phase scoped orchestration

Running only inside a phase an officer opened — capability does not confer authority.

## When this applies

Invoke this when the task in front of you is phase scoped orchestration — not by default, and not
...
It grants no capability. If applying it requires a tool `agent-orchestrator` does not hold,
