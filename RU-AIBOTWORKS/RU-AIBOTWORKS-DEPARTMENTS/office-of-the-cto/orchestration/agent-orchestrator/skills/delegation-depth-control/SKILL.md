---
name: delegation-depth-control
description: "Depth capped at two, and a child that narrows its parent's permissions but never widens them"
...
Depth capped at two, and a child that narrows its parent's permissions but never widens them.

## When this applies

Invoke this when the task in front of you is delegation depth control — not by default, and not
