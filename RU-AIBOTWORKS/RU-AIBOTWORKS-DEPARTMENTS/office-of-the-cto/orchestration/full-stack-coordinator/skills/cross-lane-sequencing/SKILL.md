---
name: cross-lane-sequencing
description: "Ordering work so each team's dependency exists before they need it"
owner: full-stack-coordinator
...
Ordering work so each team's dependency exists before they need it.

## When this applies

Invoke this when the task in front of you is cross lane sequencing — not by default, and not
...
It grants no capability. If applying it requires a tool `full-stack-coordinator` does not hold,
