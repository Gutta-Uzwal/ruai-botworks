...
description: "Noticing work that has stopped moving before the standing meeting notices it"
owner: blocker-escalation-analyst
...
Noticing work that has stopped moving before the standing meeting notices it.

## When this applies

Invoke this when the task in front of you is stall detection — not by default, and not
...
It grants no capability. If applying it requires a tool `blocker-escalation-analyst` does not hold,
