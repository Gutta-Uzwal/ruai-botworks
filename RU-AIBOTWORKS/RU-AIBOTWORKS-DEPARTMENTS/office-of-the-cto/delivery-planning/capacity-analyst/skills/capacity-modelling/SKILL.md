...
description: "Concurrent builds the company can actually carry, measured rather than hoped"
owner: capacity-analyst
...
Concurrent builds the company can actually carry, measured rather than hoped.

## When this applies

Invoke this when the task in front of you is capacity modelling — not by default, and not
...
It grants no capability. If applying it requires a tool `capacity-analyst` does not hold,
