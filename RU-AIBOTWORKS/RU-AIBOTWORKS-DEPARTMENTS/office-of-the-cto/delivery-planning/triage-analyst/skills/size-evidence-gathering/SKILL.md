---
name: size-evidence-gathering
description: "Presenting what makes this XS or L — and flagging when convenience is pushing the estimate down"
...
# size evidence gathering

Presenting what makes this xs or l — and flagging when convenience is pushing the estimate down.

## When this applies

Invoke this when the task in front of you is size evidence gathering — not by default, and not
...
It grants no capability. If applying it requires a tool `triage-analyst` does not hold,
