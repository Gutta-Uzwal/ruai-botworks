---
name: critical-path-tracking
description: "Knowing which single blocker moves the delivery date, and surfacing it the day it appears"
...
Knowing which single blocker moves the delivery date, and surfacing it the day it appears.

## When this applies

Invoke this when the task in front of you is critical path tracking — not by default, and not
...
It grants no capability. If applying it requires a tool `delivery-planner` does not hold,
