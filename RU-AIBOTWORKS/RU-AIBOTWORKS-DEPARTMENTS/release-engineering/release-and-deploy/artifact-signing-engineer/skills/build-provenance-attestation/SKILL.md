...
description: "Attesting what built this artifact, from what source, with what toolchain"
owner: artifact-signing-engineer
...
Attesting what built this artifact, from what source, with what toolchain.

## When this applies

Invoke this when the task in front of you is build provenance attestation — not by default, and not
...
It grants no capability. If applying it requires a tool `artifact-signing-engineer` does not hold,
