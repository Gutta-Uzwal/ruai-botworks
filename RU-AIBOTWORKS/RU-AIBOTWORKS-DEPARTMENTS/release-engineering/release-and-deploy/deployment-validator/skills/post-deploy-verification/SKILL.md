...
description: "Checking the thing that was deployed is the thing that was approved, by hash"
...
Checking the thing that was deployed is the thing that was approved, by hash.

## When this applies

Invoke this when the task in front of you is post deploy verification — not by default, and not
...
It grants no capability. If applying it requires a tool `deployment-validator` does not hold,
