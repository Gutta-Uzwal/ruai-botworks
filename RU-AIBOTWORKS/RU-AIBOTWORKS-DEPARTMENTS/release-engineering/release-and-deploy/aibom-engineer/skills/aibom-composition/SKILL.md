---
name: aibom-composition
description: "Models, prompts, datasets, tools and their pins — the parts an SBOM does not cover"
owner: aibom-engineer
...
Models, prompts, datasets, tools and their pins — the parts an sbom does not cover.

## When this applies

Invoke this when the task in front of you is aibom composition — not by default, and not
...
It grants no capability. If applying it requires a tool `aibom-engineer` does not hold,
