---
name: handover-pack-composition
description: "The site, the receipts and the operating instructions — what a client can act on without us"
owner: client-handover-author
...
# handover pack composition

The site, the receipts and the operating instructions — what a client can act on without us.

## When this applies

Invoke this when the task in front of you is handover pack composition — not by default, and not
...
It grants no capability. If applying it requires a tool `client-handover-author` does not hold,
