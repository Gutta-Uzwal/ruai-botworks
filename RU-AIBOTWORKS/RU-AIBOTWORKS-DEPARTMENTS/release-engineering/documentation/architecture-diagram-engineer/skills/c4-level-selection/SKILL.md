---
name: c4-level-selection
description: "Context, container, component — picking the level that answers the reader's actual question"
...
Context, container, component — picking the level that answers the reader's actual question.

## When this applies

Invoke this when the task in front of you is c4 level selection — not by default, and not
