---
name: generated-doc-discipline
description: "Every figure computed from one source, so two documents cannot disagree"
...
Every figure computed from one source, so two documents cannot disagree.

## When this applies

Invoke this when the task in front of you is generated doc discipline — not by default, and not
...
It grants no capability. If applying it requires a tool `documentation-lead` does not hold,
