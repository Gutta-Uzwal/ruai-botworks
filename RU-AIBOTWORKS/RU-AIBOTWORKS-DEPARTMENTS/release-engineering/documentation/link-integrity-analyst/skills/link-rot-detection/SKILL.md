...
description: "Checking external links too, because a dead citation is a dead claim"
owner: link-integrity-analyst
...
Checking external links too, because a dead citation is a dead claim.

## When this applies

Invoke this when the task in front of you is link rot detection — not by default, and not
...
It grants no capability. If applying it requires a tool `link-integrity-analyst` does not hold,
