---
name: contract-derived-reference
description: "Reference generated from the schema, so drift between doc and API is impossible"
...
Reference generated from the schema, so drift between doc and api is impossible.

## When this applies

Invoke this when the task in front of you is contract derived reference — not by default, and not
...
It grants no capability. If applying it requires a tool `api-documentation-engineer` does not hold,
