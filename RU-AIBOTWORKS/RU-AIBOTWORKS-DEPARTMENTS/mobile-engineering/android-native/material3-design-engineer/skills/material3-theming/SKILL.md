...
description: "Colour roles, dynamic colour and typography scale that stays legible in both themes"
owner: material3-design-engineer
...
Colour roles, dynamic colour and typography scale that stays legible in both themes.

## When this applies

Invoke this when the task in front of you is material3 theming — not by default, and not
...
It grants no capability. If applying it requires a tool `material3-design-engineer` does not hold,
