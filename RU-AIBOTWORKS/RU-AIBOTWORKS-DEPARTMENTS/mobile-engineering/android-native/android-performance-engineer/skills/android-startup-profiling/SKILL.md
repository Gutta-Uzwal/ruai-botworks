---
name: android-startup-profiling
description: "Cold-start budgets, baseline profiles and measuring on a low-end device rather than a flagship"
owner: android-performance-engineer
...
Cold-start budgets, baseline profiles and measuring on a low-end device rather than a flagship.

## When this applies

Invoke this when the task in front of you is android startup profiling — not by default, and not
...
It grants no capability. If applying it requires a tool `android-performance-engineer` does not hold,
