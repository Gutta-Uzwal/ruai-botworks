...
description: "Conflict resolution, tombstones and a sync that survives a week offline"
owner: android-data-engineer
...
Conflict resolution, tombstones and a sync that survives a week offline.

## When this applies

Invoke this when the task in front of you is offline first sync — not by default, and not
...
It grants no capability. If applying it requires a tool `android-data-engineer` does not hold,
