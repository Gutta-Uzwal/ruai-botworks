---
name: android-lifecycle-correctness
description: "Configuration change, process death and saved state — the three that produce most Android defects"
...
Configuration change, process death and saved state — the three that produce most android defects.

## When this applies

Invoke this when the task in front of you is android lifecycle correctness — not by default, and not
...
It grants no capability. If applying it requires a tool `android-architect` does not hold,
