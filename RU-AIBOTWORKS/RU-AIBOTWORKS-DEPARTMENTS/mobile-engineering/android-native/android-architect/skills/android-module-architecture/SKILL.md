...
description: "Feature modules, Gradle boundaries and a dependency graph that keeps build times sane"
...
Feature modules, gradle boundaries and a dependency graph that keeps build times sane.

## When this applies

Invoke this when the task in front of you is android module architecture — not by default, and not
