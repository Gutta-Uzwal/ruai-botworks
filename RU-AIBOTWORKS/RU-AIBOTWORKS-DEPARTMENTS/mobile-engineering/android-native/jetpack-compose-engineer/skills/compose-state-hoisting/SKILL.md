...
description: "Stateless composables, hoisted state and recomposition scope you can actually reason about"
...
Stateless composables, hoisted state and recomposition scope you can actually reason about.

## When this applies

Invoke this when the task in front of you is compose state hoisting — not by default, and not
