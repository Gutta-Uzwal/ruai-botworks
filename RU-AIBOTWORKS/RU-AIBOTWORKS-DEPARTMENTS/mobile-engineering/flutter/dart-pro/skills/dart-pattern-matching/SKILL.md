...
description: "Sealed classes and exhaustive switches that make illegal states unrepresentable"
owner: dart-pro
...
Sealed classes and exhaustive switches that make illegal states unrepresentable.

## When this applies

Invoke this when the task in front of you is dart pattern matching — not by default, and not
...
It grants no capability. If applying it requires a tool `dart-pro` does not hold,
