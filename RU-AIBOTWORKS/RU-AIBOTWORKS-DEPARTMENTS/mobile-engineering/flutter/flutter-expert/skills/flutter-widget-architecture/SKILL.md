...
description: "Composition over inheritance, const constructors and rebuild boundaries"
...
Composition over inheritance, const constructors and rebuild boundaries.

## When this applies

Invoke this when the task in front of you is flutter widget architecture — not by default, and not
