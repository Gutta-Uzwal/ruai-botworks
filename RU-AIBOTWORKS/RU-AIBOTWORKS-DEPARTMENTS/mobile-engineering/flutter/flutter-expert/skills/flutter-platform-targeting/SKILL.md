---
name: flutter-platform-targeting
description: "What one codebase genuinely shares across Android, iOS and web — and what it never will"
owner: flutter-expert
...
# flutter platform targeting

What one codebase genuinely shares across android, ios and web — and what it never will.

## When this applies

Invoke this when the task in front of you is flutter platform targeting — not by default, and not
...
It grants no capability. If applying it requires a tool `flutter-expert` does not hold,
