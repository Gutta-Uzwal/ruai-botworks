---
name: reanimated-gesture-design
description: "Worklets on the UI thread, and keeping 60fps off the JS thread entirely"
owner: rn-native-module-engineer
...
# reanimated gesture design

Worklets on the ui thread, and keeping 60fps off the js thread entirely.

## When this applies

Invoke this when the task in front of you is reanimated gesture design — not by default, and not
...
It grants no capability. If applying it requires a tool `rn-native-module-engineer` does not hold,
