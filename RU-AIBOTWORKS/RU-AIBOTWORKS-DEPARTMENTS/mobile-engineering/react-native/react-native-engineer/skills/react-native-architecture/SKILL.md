...
description: "New architecture, bridge cost and what actually belongs on the native side"
...
New architecture, bridge cost and what actually belongs on the native side.

## When this applies

Invoke this when the task in front of you is react native architecture — not by default, and not
