---
name: rn-web-skill-reuse
description: "Which web-lane React patterns carry over to mobile, and which quietly do not"
...
Which web-lane react patterns carry over to mobile, and which quietly do not.

## When this applies

Invoke this when the task in front of you is rn web skill reuse — not by default, and not
...
It grants no capability. If applying it requires a tool `react-native-engineer` does not hold,
