...
description: "Update channels, rollback and never shipping a native-incompatible JS bundle"
owner: expo-release-engineer
...
Update channels, rollback and never shipping a native-incompatible js bundle.

## When this applies

Invoke this when the task in front of you is ota update safety — not by default, and not
...
It grants no capability. If applying it requires a tool `expo-release-engineer` does not hold,
