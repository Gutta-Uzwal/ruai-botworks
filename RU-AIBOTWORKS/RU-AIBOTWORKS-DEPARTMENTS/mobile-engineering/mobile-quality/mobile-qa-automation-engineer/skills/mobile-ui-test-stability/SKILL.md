---
name: mobile-ui-test-stability
description: "Idling resources and deterministic waits — why sleep-based mobile tests always rot"
owner: mobile-qa-automation-engineer
...
# mobile ui test stability

Idling resources and deterministic waits — why sleep-based mobile tests always rot.

## When this applies

Invoke this when the task in front of you is mobile ui test stability — not by default, and not
...
It grants no capability. If applying it requires a tool `mobile-qa-automation-engineer` does not hold,
