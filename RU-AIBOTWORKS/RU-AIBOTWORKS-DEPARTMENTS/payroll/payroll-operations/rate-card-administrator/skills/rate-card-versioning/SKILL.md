---
name: rate-card-versioning
description: "Rates versioned by effective date, so a historical period recosts to what it actually cost"
...
Rates versioned by effective date, so a historical period recosts to what it actually cost.

## When this applies

Invoke this when the task in front of you is rate card versioning — not by default, and not
