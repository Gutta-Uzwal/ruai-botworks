---
name: meter-completeness
description: "Every run metered — an unmetered agent is an unpaid one, and unpaid work is invisible cost"
owner: metering-lead
department: payroll
team: metering
...
Every run metered — an unmetered agent is an unpaid one, and unpaid work is invisible cost.

## When this applies

Invoke this when the task in front of you is meter completeness — not by default, and not
...
It grants no capability. If applying it requires a tool `metering-lead` does not hold,
