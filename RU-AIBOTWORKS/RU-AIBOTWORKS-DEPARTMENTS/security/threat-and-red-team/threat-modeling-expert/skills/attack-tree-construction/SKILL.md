...
description: "Building the tree down to a leaf someone could actually execute"
...
Building the tree down to a leaf someone could actually execute.

## When this applies

Invoke this when the task in front of you is attack tree construction — not by default, and not
