---
name: agent-hijack-simulation
description: "Testing the blast-radius claim by assuming the agent is fully compromised and seeing how far it reaches"
owner: red-team-operator
department: security
...
# agent hijack simulation

Testing the blast-radius claim by assuming the agent is fully compromised and seeing how far it reaches.

## When this applies

Invoke this when the task in front of you is agent hijack simulation — not by default, and not
...
It grants no capability. If applying it requires a tool `red-team-operator` does not hold,
