---
name: finding-severity-triage
description: "Exploitability in this deployment, not CVSS copied from the advisory"
owner: appsec-lead
department: security
...
Exploitability in this deployment, not cvss copied from the advisory.

## When this applies

Invoke this when the task in front of you is finding severity triage — not by default, and not
...
It grants no capability. If applying it requires a tool `appsec-lead` does not hold,
