---
name: owasp-asi-review
description: "The 2026 agentic top ten as the review vocabulary, ASI03 authorisation first"
...
The 2026 agentic top ten as the review vocabulary, asi03 authorisation first.

## When this applies

Invoke this when the task in front of you is owasp asi review — not by default, and not
...
It grants no capability. If applying it requires a tool `security-auditor` does not hold,
