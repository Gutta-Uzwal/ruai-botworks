---
name: dependency-justification-review
description: "Asking what this dependency costs to maintain, not only what it saves to adopt"
owner: dependency-review-engineer
...
Asking what this dependency costs to maintain, not only what it saves to adopt.

## When this applies

Invoke this when the task in front of you is dependency justification review — not by default, and not
...
It grants no capability. If applying it requires a tool `dependency-review-engineer` does not hold,
