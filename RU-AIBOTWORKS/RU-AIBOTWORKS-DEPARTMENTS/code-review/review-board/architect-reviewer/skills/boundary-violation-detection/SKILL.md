...
description: "Finding the import that crosses a layer, and why it will be load-bearing in six months"
...
Finding the import that crosses a layer, and why it will be load-bearing in six months.

## When this applies

Invoke this when the task in front of you is boundary violation detection — not by default, and not
...
It grants no capability. If applying it requires a tool `architect-reviewer` does not hold,
