---
name: reviewer-independence-routing
description: "Never routing a candidate to a reviewer who contributed to it"
owner: review-board-lead
...
# reviewer independence routing

Never routing a candidate to a reviewer who contributed to it.

## When this applies

Invoke this when the task in front of you is reviewer independence routing — not by default, and not
...
It grants no capability. If applying it requires a tool `review-board-lead` does not hold,
