...
description: "Matching page type to intent — informational, navigational or transactional"
...
Matching page type to intent — informational, navigational or transactional.

## When this applies

Invoke this when the task in front of you is search intent mapping — not by default, and not
...
It grants no capability. If applying it requires a tool `seo-content-strategist` does not hold,
