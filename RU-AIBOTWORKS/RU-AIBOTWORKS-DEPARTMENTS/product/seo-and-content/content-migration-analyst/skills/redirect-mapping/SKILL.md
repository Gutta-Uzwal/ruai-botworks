...
description: "A redirect for every retired URL, because a 404 discards ranking earned over years"
owner: content-migration-analyst
department: product
...
A redirect for every retired url, because a 404 discards ranking earned over years.

## When this applies

Invoke this when the task in front of you is redirect mapping — not by default, and not
...
It grants no capability. If applying it requires a tool `content-migration-analyst` does not hold,
