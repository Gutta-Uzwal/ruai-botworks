---
name: post-launch-seo-monitoring
description: "Watching index coverage in the weeks after launch, when regressions actually appear"
owner: seo-monitoring-analyst
department: product
...
Watching index coverage in the weeks after launch, when regressions actually appear.

## When this applies

Invoke this when the task in front of you is post launch seo monitoring — not by default, and not
...
It grants no capability. If applying it requires a tool `seo-monitoring-analyst` does not hold,
