---
name: seo-strategy-scoping
description: "Deciding what this site can realistically rank for, and declining the rest honestly"
owner: seo-lead
department: product
...
# seo strategy scoping

Deciding what this site can realistically rank for, and declining the rest honestly.

## When this applies

Invoke this when the task in front of you is seo strategy scoping — not by default, and not
...
It grants no capability. If applying it requires a tool `seo-lead` does not hold,
