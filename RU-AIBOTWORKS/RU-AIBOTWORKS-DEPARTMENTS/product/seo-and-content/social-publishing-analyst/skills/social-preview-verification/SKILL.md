...
description: "Verifying the card renders, rather than trusting the tags are correct"
owner: social-publishing-analyst
department: product
...
Verifying the card renders, rather than trusting the tags are correct.

## When this applies

Invoke this when the task in front of you is social preview verification — not by default, and not
...
It grants no capability. If applying it requires a tool `social-publishing-analyst` does not hold,
