...
description: "Schema.org markup that validates, matching what is actually on the page"
...
Schema.org markup that validates, matching what is actually on the page.

## When this applies

Invoke this when the task in front of you is structured data implementation — not by default, and not
...
It grants no capability. If applying it requires a tool `technical-seo-engineer` does not hold,
