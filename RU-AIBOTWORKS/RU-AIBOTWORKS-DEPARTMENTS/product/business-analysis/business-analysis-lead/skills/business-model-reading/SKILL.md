...
description: "Finding how the client actually makes money, which is rarely what the brief emphasises"
...
Finding how the client actually makes money, which is rarely what the brief emphasises.

## When this applies

Invoke this when the task in front of you is business model reading — not by default, and not
...
It grants no capability. If applying it requires a tool `business-analysis-lead` does not hold,
