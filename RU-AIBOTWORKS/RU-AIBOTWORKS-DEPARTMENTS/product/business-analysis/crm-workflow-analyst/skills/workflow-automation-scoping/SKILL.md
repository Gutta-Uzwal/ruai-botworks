---
name: workflow-automation-scoping
description: "Automating the step that repeats, and leaving the judgement step to a person"
owner: crm-workflow-analyst
department: product
...
Automating the step that repeats, and leaving the judgement step to a person.

## When this applies

Invoke this when the task in front of you is workflow automation scoping — not by default, and not
...
It grants no capability. If applying it requires a tool `crm-workflow-analyst` does not hold,
