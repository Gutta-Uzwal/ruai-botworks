...
description: "Reading what competitors do well before proposing what to do differently"
...
Reading what competitors do well before proposing what to do differently.

## When this applies

Invoke this when the task in front of you is competitor teardown — not by default, and not
...
It grants no capability. If applying it requires a tool `competitive-analyst` does not hold,
