...
description: "Tiering that matches willingness to pay rather than engineering convenience"
owner: pricing-and-packaging-analyst
department: product
...
Tiering that matches willingness to pay rather than engineering convenience.

## When this applies

Invoke this when the task in front of you is packaging advice — not by default, and not
...
It grants no capability. If applying it requires a tool `pricing-and-packaging-analyst` does not hold,
