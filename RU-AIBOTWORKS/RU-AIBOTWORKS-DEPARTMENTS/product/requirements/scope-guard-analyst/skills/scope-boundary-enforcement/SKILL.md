...
description: "Naming what was added and what it displaces, rather than silently absorbing it"
owner: scope-guard-analyst
department: product
team: requirements
...
Naming what was added and what it displaces, rather than silently absorbing it.

## When this applies

Invoke this when the task in front of you is scope boundary enforcement — not by default, and not
...
It grants no capability. If applying it requires a tool `scope-guard-analyst` does not hold,
