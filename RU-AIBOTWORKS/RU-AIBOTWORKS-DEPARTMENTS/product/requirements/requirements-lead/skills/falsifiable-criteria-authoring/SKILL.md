---
name: falsifiable-criteria-authoring
description: "Writing criteria that can fail — a criterion nobody can fail is decoration"
...
Writing criteria that can fail — a criterion nobody can fail is decoration.

## When this applies

Invoke this when the task in front of you is falsifiable criteria authoring — not by default, and not
...
It grants no capability. If applying it requires a tool `requirements-lead` does not hold,
