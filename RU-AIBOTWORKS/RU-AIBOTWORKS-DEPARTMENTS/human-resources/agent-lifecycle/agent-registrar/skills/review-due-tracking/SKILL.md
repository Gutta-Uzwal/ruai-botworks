---
name: review-due-tracking
description: "Every record carries a review date, and a lapsed review suspends the agent rather than being noted"
...
Every record carries a review date, and a lapsed review suspends the agent rather than being noted.

## When this applies

Invoke this when the task in front of you is review due tracking — not by default, and not
