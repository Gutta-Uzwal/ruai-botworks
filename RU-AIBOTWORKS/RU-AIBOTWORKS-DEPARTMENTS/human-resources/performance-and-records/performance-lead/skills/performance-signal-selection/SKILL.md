---
name: performance-signal-selection
description: "Measuring outcomes an officer acted on, not volume of output"
...
# performance signal selection

Measuring outcomes an officer acted on, not volume of output.

## When this applies

Invoke this when the task in front of you is performance signal selection — not by default, and not
...
It grants no capability. If applying it requires a tool `performance-lead` does not hold,
