...
description: "Reconciling the registry against what actually exists on disk, and failing on any disagreement"
owner: workforce-records-clerk
...
Reconciling the registry against what actually exists on disk, and failing on any disagreement.

## When this applies

Invoke this when the task in front of you is headcount reconciliation — not by default, and not
...
It grants no capability. If applying it requires a tool `workforce-records-clerk` does not hold,
