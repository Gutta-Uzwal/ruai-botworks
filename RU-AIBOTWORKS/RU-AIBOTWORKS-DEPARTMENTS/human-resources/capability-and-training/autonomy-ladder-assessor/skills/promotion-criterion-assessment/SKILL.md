---
name: promotion-criterion-assessment
description: "Agreement rate over a statistically useful sample, a clean evaluation suite and no policy violations in the window"
owner: autonomy-ladder-assessor
...
# promotion criterion assessment

Agreement rate over a statistically useful sample, a clean evaluation suite and no policy violations in the window.

## When this applies

Invoke this when the task in front of you is promotion criterion assessment — not by default, and not
...
It grants no capability. If applying it requires a tool `autonomy-ladder-assessor` does not hold,
