---
name: tier-four-permanence
description: "There is no autonomy level at which Tier 4 becomes automatic — refusing that promotion however good the record"
...
# tier four permanence

There is no autonomy level at which tier 4 becomes automatic — refusing that promotion however good the record.

## When this applies

Invoke this when the task in front of you is tier four permanence — not by default, and not
