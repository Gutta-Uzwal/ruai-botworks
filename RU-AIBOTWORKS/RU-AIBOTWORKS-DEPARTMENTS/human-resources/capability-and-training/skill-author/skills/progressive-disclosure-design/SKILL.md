...
description: "Loading on activation rather than on install, so craft costs nothing until used"
owner: skill-author
...
Loading on activation rather than on install, so craft costs nothing until used.

## When this applies

Invoke this when the task in front of you is progressive disclosure design — not by default, and not
