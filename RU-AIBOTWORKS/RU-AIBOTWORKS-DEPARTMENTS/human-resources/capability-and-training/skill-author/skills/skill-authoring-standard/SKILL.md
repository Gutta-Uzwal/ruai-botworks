...
description: "A skill teaches method and grants nothing — if it needs a tool the contract lacks, the call is denied"
owner: skill-author
...
A skill teaches method and grants nothing — if it needs a tool the contract lacks, the call is denied.

## When this applies

Invoke this when the task in front of you is skill authoring standard — not by default, and not
...
It grants no capability. If applying it requires a tool `skill-author` does not hold,
