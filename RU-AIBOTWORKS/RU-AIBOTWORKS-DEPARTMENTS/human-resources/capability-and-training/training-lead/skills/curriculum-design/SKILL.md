...
description: "Defining the craft a role needs, and the evidence that it has it"
owner: training-lead
...
Defining the craft a role needs, and the evidence that it has it.

## When this applies

Invoke this when the task in front of you is curriculum design — not by default, and not
...
It grants no capability. If applying it requires a tool `training-lead` does not hold,
