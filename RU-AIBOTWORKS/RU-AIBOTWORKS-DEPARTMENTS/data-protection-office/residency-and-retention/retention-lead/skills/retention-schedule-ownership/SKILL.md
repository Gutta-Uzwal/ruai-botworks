---
name: retention-schedule-ownership
description: "A declared period per data class, enforced in the schema rather than in a policy document"
...
A declared period per data class, enforced in the schema rather than in a policy document.

## When this applies

Invoke this when the task in front of you is retention schedule ownership — not by default, and not
...
It grants no capability. If applying it requires a tool `retention-lead` does not hold,
