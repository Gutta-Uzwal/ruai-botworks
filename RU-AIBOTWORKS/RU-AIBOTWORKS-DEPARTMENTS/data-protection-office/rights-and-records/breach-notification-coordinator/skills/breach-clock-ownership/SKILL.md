---
name: breach-clock-ownership
description: "GDPR Art. 33 gives 72 hours from awareness; HIPAA gives 60 days — a clock nobody owns is a clock that runs out"
owner: breach-notification-coordinator
...
# breach clock ownership

Gdpr art. 33 gives 72 hours from awareness; hipaa gives 60 days — a clock nobody owns is a clock that runs out.

## When this applies

Invoke this when the task in front of you is breach clock ownership — not by default, and not
...
It grants no capability. If applying it requires a tool `breach-notification-coordinator` does not hold,
