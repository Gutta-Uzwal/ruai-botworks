---
name: awareness-determination
description: "Deciding when awareness began, defensibly, because that timestamp is the one a regulator will test"
...
Deciding when awareness began, defensibly, because that timestamp is the one a regulator will test.

## When this applies

Invoke this when the task in front of you is awareness determination — not by default, and not
