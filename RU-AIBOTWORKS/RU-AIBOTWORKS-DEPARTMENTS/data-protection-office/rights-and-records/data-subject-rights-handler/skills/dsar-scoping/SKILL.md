---
name: dsar-scoping
description: "Finding every copy including backups and logs, and saying honestly what cannot be erased and why"
owner: data-subject-rights-handler
...
Finding every copy including backups and logs, and saying honestly what cannot be erased and why.

## When this applies

Invoke this when the task in front of you is dsar scoping — not by default, and not
...
It grants no capability. If applying it requires a tool `data-subject-rights-handler` does not hold,
