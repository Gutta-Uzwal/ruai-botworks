...
description: "Data minimisation and purpose limitation assessed at the schema, where they are still cheap to fix"
...
Data minimisation and purpose limitation assessed at the schema, where they are still cheap to fix.

## When this applies

Invoke this when the task in front of you is privacy by design review — not by default, and not
...
It grants no capability. If applying it requires a tool `privacy-engineering-lead` does not hold,
