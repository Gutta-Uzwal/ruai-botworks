...
description: "Naming the lawful basis per processing activity, because consent is usually not the right one"
...
Naming the lawful basis per processing activity, because consent is usually not the right one.

## When this applies

Invoke this when the task in front of you is lawful basis assessment — not by default, and not
