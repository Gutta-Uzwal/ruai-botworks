---
name: consent-implementation-review
description: "Consent before the first beacon, granular, and as easy to withdraw as to give"
...
Consent before the first beacon, granular, and as easy to withdraw as to give.

## When this applies

Invoke this when the task in front of you is consent implementation review — not by default, and not
...
It grants no capability. If applying it requires a tool `gdpr-compliance-officer` does not hold,
