---
name: baa-prerequisite-check
description: "Treating a Business Associate Agreement as a client-side prerequisite we verify rather than assume"
...
# baa prerequisite check

Treating a business associate agreement as a client-side prerequisite we verify rather than assume.

## When this applies

Invoke this when the task in front of you is baa prerequisite check — not by default, and not
...
It grants no capability. If applying it requires a tool `hipaa-compliance-officer` does not hold,
