---
name: deck-narrative-construction
description: "One argument per slide, and a deck that survives being read without the speaker"
...
# deck narrative construction

One argument per slide, and a deck that survives being read without the speaker.

## When this applies

Invoke this when the task in front of you is deck narrative construction — not by default, and not
...
It grants no capability. If applying it requires a tool `presentation-designer` does not hold,
