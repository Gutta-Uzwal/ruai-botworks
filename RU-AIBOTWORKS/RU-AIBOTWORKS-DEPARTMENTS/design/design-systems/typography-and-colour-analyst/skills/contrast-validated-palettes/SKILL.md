---
name: contrast-validated-palettes
description: "Palettes validated against contrast requirements in both themes before they are adopted"
owner: typography-and-colour-analyst
department: design
team: design-systems
...
# contrast validated palettes

Palettes validated against contrast requirements in both themes before they are adopted.

## When this applies

Invoke this when the task in front of you is contrast validated palettes — not by default, and not
...
It grants no capability. If applying it requires a tool `typography-and-colour-analyst` does not hold,
