---
name: design-rationale-recording
description: "Writing why this direction, so the next project does not repeat it by accident"
...
Writing why this direction, so the next project does not repeat it by accident.

## When this applies

Invoke this when the task in front of you is design rationale recording — not by default, and not
