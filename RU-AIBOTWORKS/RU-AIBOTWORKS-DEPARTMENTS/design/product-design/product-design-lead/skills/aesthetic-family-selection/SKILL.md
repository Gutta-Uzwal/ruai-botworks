---
name: aesthetic-family-selection
description: "Picking a family per template deliberately, because the anti-sameness test is two templates that do not look related"
...
# aesthetic family selection

Picking a family per template deliberately, because the anti-sameness test is two templates that do not look related.

## When this applies

Invoke this when the task in front of you is aesthetic family selection — not by default, and not
...
It grants no capability. If applying it requires a tool `product-design-lead` does not hold,
