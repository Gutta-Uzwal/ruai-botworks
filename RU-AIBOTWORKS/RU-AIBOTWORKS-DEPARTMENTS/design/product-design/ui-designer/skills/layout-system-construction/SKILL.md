---
name: layout-system-construction
description: "Spacing scale, grid and rhythm decided once and applied everywhere"
owner: ui-designer
department: design
team: product-design
...
# layout system construction

Spacing scale, grid and rhythm decided once and applied everywhere.

## When this applies

Invoke this when the task in front of you is layout system construction — not by default, and not
...
It grants no capability. If applying it requires a tool `ui-designer` does not hold,
