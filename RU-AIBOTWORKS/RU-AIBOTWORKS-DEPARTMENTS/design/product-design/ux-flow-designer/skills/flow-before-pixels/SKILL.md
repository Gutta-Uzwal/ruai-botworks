---
name: flow-before-pixels
description: "Settling the path through the product before deciding what any screen looks like"
...
Settling the path through the product before deciding what any screen looks like.

## When this applies

Invoke this when the task in front of you is flow before pixels — not by default, and not
...
It grants no capability. If applying it requires a tool `ux-flow-designer` does not hold,
