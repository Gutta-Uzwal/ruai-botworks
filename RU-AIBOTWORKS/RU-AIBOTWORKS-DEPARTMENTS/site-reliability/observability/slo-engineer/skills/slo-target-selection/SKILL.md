---
name: slo-target-selection
description: "Targets from what users notice rather than from a round number of nines"
owner: slo-engineer
...
Targets from what users notice rather than from a round number of nines.

## When this applies

Invoke this when the task in front of you is slo target selection — not by default, and not
...
It grants no capability. If applying it requires a tool `slo-engineer` does not hold,
