---
name: append-only-log-integrity
description: "Written under a different principal, hash-chained, and retained to the longest applicable obligation"
...
Written under a different principal, hash-chained, and retained to the longest applicable obligation.

## When this applies

Invoke this when the task in front of you is append only log integrity — not by default, and not
