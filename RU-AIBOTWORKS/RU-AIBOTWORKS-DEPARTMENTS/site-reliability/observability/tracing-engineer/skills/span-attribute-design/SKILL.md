---
name: span-attribute-design
description: "Attributes that answer questions during an incident, not attributes that were easy to add"
owner: tracing-engineer
...
Attributes that answer questions during an incident, not attributes that were easy to add.

## When this applies

Invoke this when the task in front of you is span attribute design — not by default, and not
...
It grants no capability. If applying it requires a tool `tracing-engineer` does not hold,
