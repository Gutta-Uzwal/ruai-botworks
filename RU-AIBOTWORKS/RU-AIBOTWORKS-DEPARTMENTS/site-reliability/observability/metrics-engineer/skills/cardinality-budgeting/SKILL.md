---
name: cardinality-budgeting
description: "Labels bounded before they are added, because unbounded cardinality kills the metrics store"
...
Labels bounded before they are added, because unbounded cardinality kills the metrics store.

## When this applies

Invoke this when the task in front of you is cardinality budgeting — not by default, and not
...
It grants no capability. If applying it requires a tool `metrics-engineer` does not hold,
