---
name: kill-switch-game-day
description: "Pulling it in production on a real agent, quarterly, and publishing per-layer wall-clock figures"
...
Pulling it in production on a real agent, quarterly, and publishing per-layer wall-clock figures.

## When this applies

Invoke this when the task in front of you is kill switch game day — not by default, and not
