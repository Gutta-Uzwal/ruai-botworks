---
name: mandate-versus-action-divergence
description: "The cheapest check with the highest catch rate — comparing what the agent was told to do with what it did"
owner: runaway-detection-engineer
...
# mandate versus action divergence

The cheapest check with the highest catch rate — comparing what the agent was told to do with what it did.

## When this applies

Invoke this when the task in front of you is mandate versus action divergence — not by default, and not
...
It grants no capability. If applying it requires a tool `runaway-detection-engineer` does not hold,
