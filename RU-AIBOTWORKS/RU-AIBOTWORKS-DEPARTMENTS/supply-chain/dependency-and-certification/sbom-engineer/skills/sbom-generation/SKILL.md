...
description: "A complete component inventory, including transitive dependencies and their licences"
owner: sbom-engineer
...
A complete component inventory, including transitive dependencies and their licences.

## When this applies

Invoke this when the task in front of you is sbom generation — not by default, and not
...
It grants no capability. If applying it requires a tool `sbom-engineer` does not hold,
