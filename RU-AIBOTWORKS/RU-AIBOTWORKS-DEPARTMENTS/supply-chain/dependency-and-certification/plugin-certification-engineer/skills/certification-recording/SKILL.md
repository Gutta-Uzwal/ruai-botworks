---
name: certification-recording
description: "Recording the certification ID against the exact pin it was issued for"
owner: plugin-certification-engineer
...
Recording the certification id against the exact pin it was issued for.

## When this applies

Invoke this when the task in front of you is certification recording — not by default, and not
...
It grants no capability. If applying it requires a tool `plugin-certification-engineer` does not hold,
