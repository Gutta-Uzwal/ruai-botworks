---
name: divergence-recording
description: "Undocumented drift is indistinguishable from an accident"
owner: divergence-logger
...
Invoke this when the task in front of you is divergence recording — not by default, and not
...
It grants no capability. If applying it requires a tool `divergence-logger` does not hold,
