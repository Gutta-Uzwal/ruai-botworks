---
name: context-baseline-measurement
description: "Tracking the baseline weekly, because rot is gradual and invisible without a trend"
owner: context-budget-analyst
...
Tracking the baseline weekly, because rot is gradual and invisible without a trend.

## When this applies

Invoke this when the task in front of you is context baseline measurement — not by default, and not
...
It grants no capability. If applying it requires a tool `context-budget-analyst` does not hold,
