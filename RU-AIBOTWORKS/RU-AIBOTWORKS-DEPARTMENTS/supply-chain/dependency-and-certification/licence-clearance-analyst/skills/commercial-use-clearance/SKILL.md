---
name: commercial-use-clearance
description: "Clearing commercial use explicitly — an unverified licence on a gate-blocking component is a production risk"
owner: licence-clearance-analyst
...
Clearing commercial use explicitly — an unverified licence on a gate-blocking component is a production risk.

## When this applies

Invoke this when the task in front of you is commercial use clearance — not by default, and not
...
It grants no capability. If applying it requires a tool `licence-clearance-analyst` does not hold,
