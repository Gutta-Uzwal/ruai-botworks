---
name: pin-discipline
description: "Pinning by commit, never by branch name — a branch pin is not a pin"
owner: dependency-lead
...
Pinning by commit, never by branch name — a branch pin is not a pin.

## When this applies

Invoke this when the task in front of you is pin discipline — not by default, and not
...
It grants no capability. If applying it requires a tool `dependency-lead` does not hold,
