...
Every figure below is computed by `RU-AIBOTWORKS-PLATFORM/ru_aibotworks_registry.py`.
...
python RU-AIBOTWORKS/RU-AIBOTWORKS-PLATFORM/ru_aibotworks_genome.py --validate

# 2. Generated output must not be stale
python RU-AIBOTWORKS/RU-AIBOTWORKS-PLATFORM/ru_aibotworks_generate.py --check

# 3. Push one typo all the way through
git checkout dev
echo "." >> RU-AIBOTWORKS/RU-AIBOTWORKS-DOCS/charter/RU-AIBOTWORKS-00-START-HERE.md
...
python RU-AIBOTWORKS/RU-AIBOTWORKS-PLATFORM/ru_aibotworks_registry.py --table

# the harness — 24 checks over every agent
python RU-AIBOTWORKS/RU-AIBOTWORKS-PLATFORM/ru_aibotworks_genome.py --validate --verbose
...
python RU-AIBOTWORKS/RU-AIBOTWORKS-PLATFORM/ru_aibotworks_portal.py

# rebuild and load the control database
python RU-AIBOTWORKS/RU-AIBOTWORKS-PLATFORM/ru_aibotworks_seed_sql.py
sqlcmd -S localhost -E -C -b -i RU-AIBOTWORKS/RU-AIBOTWORKS-DATABASE/RU-AIBOTWORKS-seed.sql
```

**To hire an agent:** add ~12 lines to a file in `RU-AIBOTWORKS-REGISTRY/workforce/`,
