...
OUT = ROOT / "RU-AIBOTWORKS-DEPARTMENTS"
...
def render_agent_tools_json(company: Company) -> str:
    ...
    doc = {
        "version": 1,
        "_generated": "RU-AIBOTWORKS-PLATFORM/ru_aibotworks_generate.py — do not hand-edit",
        "_source": "RU-AIBOTWORKS-REGISTRY/ru-aibotworks-tools.yaml",
        "egress": company.tools["egress"],
        "forbidden_identities": company.tools["forbidden_identities"],
